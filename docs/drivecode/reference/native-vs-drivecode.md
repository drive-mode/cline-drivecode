...
| Temporary presentation authority | No Drive title contract | Exclusive, scoped Presenter grant; signed host-side Director policy | `shipped` | [SDK architecture](../../../sdk/ARCHITECTURE.md#drive-presenter-authority-and-director-policy); merged [PR #17](https://github.com/drive-mode/cline-drivecode/pull/17) |
