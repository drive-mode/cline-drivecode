...
| [10-upstream-sdk-sync-handoff.md](delivery/10-upstream-sdk-sync-handoff.md) | Operational handoff for keeping the fork current with `cline/cline` and distinguishing SDK release parity from source-head parity. |
