...
| [15-agent-first-design.md](research/15-agent-first-design.md) | Agent-first design doctrine stress-tested against the Drive runtime; gaps, diagnostic, where Drive stands |
