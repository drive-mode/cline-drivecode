...
async function main(): Promise<void> {
	...
	const workspaceRoot = realpathSync(resolve(options.cwd));
	...
	let chatManagement: ReturnType<
		typeof createHubDaemonChatManagementComposition
	>;
	try {
		chatManagement = createHubDaemonChatManagementComposition({
			workspaceRoot,
